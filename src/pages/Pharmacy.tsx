        ...
        <div className="relative z-10 mx-auto w-full max-w-7xl px-6 py-40">
          <motion.div initial="hidden" animate="visible" variants={fadeUp} className="max-w-4xl">
            ...
            <h1 className="text-5xl font-bold leading-[1.08] tracking-tight text-primary-foreground md:text-7xl lg:text-8xl">
              Smarter Locum Cover for{" "}
              <span className="text-[#0075FF]">UK Pharmacies</span>
            </h1>
            <motion.p
              initial="hidden"
              animate="visible"
            ...
            >
              Flexzo.ai is an AI-powered pharmacy staffing platform designed to help UK pharmacies
              reduce staffing gaps, improve workforce planning, and cut reliance on expensive agencies.
            </motion.p>
            <motion.div
              initial="hidden"
              animate="visible"
        ...
        <div className="mx-auto max-w-7xl px-6">
          ...
          >
            <h2 className="text-4xl font-bold leading-[1.15] tracking-tight text-foreground md:text-6xl lg:text-7xl">
              Pharmacy Staffing &{" "}
              <span className="text-[#0075FF]">Recruitment Platform</span>
            </h2>
            <p className="mt-8 max-w-3xl text-xl leading-relaxed text-muted-foreground md:text-2xl">
              Whether you need urgent locum pharmacist cover, support for service delivery, or
              long-term recruitment solutions, Flexzo.ai connects pharmacies with compliant
          ...
          <div className="grid gap-16 lg:grid-cols-2">
            ...
            >
              ...
              <h2 className="text-3xl font-bold leading-tight tracking-tight text-primary-foreground md:text-5xl">
                Solve Pharmacy Staffing Shortages{" "}
                <span className="text-[#0075FF]">Faster</span>
              </h2>
              <p className="mt-6 text-lg leading-relaxed text-primary-foreground/60">
                Pharmacies across the UK are facing increasing pressure from staff shortages,
                rising locum costs, and growing demand for clinical pharmacy services.
              </p>
            </motion.div>
        ...
        <div className="mx-auto max-w-7xl px-6">
          <div className="grid gap-12 lg:grid-cols-3">
            {[
              {
                icon: Brain,
                title: "AI-Powered Recruitment & Locum Matching",
                desc: "Flexzo.ai uses intelligent matching technology to connect pharmacies with suitable, compliant professionals based on availability and role requirements. Our platform supports faster booking and improved shift coverage while reducing the time spent sourcing staff manually.",
              },
              {
                icon: TrendingDown,
                title: "Reduce Locum and Agency Costs",
                desc: "Agency mark-ups continue to drive up the cost of pharmacy recruitment. Flexzo.ai offers a transparent subscription-based model, helping pharmacies reduce unnecessary fees and gain more control over staffing spend.",
              },
              {
                icon: Shield,
                title: "Compliance-Ready Pharmacy Professionals",
                desc: "Flexzo.ai supports safer recruitment by providing access to professionals who are pre-vetted and compliance-ready, helping pharmacies stay audit-ready while reducing administrative workload.",
              },
            ].map((f, i) => (
              <motion.div
                key={f.title}
        ...
        <div className="mx-auto max-w-4xl px-6 text-center">
          ...
          >
            ...
            <p className="mx-auto mt-6 max-w-2xl text-lg text-muted-foreground">
              Looking for a smarter way to manage pharmacy staffing and recruitment?
              Book a demo today and discover how Flexzo.ai can help your pharmacy reduce
              rota gaps, lower agency spend, and improve operational efficiency.
            </p>
