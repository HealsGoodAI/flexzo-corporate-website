...
const keyBenefits = [
  {
    icon: Users,
    title: "One Platform. All Staff.",
    description:
      "From doctors and nurses to porters and allied health professionals — roster every staff group across multi-disciplinary teams. Skills, leave requests and working patterns are all accounted for, ensuring you operate effectively and to budget.",
  },
  {
    icon: Brain,
    title: "Agentic & Human Intelligence",
    description:
      "Combine professional clinical judgement with our Agentic Intelligence Engine. Take the guesswork and mundane tasks out of building the perfect roster — balancing budgets, fairness, safety, compliance rules and clinical demand.",
  },
  {
    icon: Activity,
    title: "Productivity & Efficiency",
    description:
      "Match staff numbers and skills to care needs with demand-based rostering. Reduce cancelled care, unnecessary agency use and lost capacity by understanding exactly what needs to be delivered.",
  },
  {
    icon: Clock,
    title: "Real-Time Dynamic Rostering",
    description:
      "Things change before and during shifts. See changes in care needs and staff availability as they happen, with AI-driven predictive acuity giving you a real-time command centre for your workforce across teams and sites.",
  },
];
...
const features = [
  {
    icon: CalendarDays,
    title: "Availability & Absence Management",
    description:
      "Manage annual leave, sickness, study leave and additional shift requests with full visibility and control. Sophisticated skills tracking and work regulation rules built in.",
  },
  {
    icon: Target,
    title: "Activity-Based Rostering",
    description:
      "Schedule the right multi-professional team by understanding exact clinical activity — from theatres to laboratories. Prevent cancelled care and maximise team productivity.",
  },
  {
    icon: BarChart3,
    title: "Staffing Command Centre",
    description:
      "Live mobile view of staffing deployment across multiple sites. Real-time visibility of staffing levels and care needs for bed meetings, command centres and senior executives on call.",
  },
  {
    icon: Layers,
    title: "Integrated Temporary Staffing",
    description:
      "Fully integrated bank, shared bank and agency solutions ensure temporary staffing is only used when needed, at the right cost, with maximum control of quality.",
  },
  {
    icon: ShieldCheck,
    title: "Compliance & Governance",
    description:
      "Encode trust-specific rules, supervision ratios, protected training time and local pay bands. Every roster decision is auditable and policy-compliant.",
  },
  {
    icon: Smartphone,
    title: "Staff Self-Service App",
    description:
      "Put the roster in staff hands. View personal rosters, book bank shifts, request changes and communicate with teams — all from one integrated mobile app.",
  },
];
...
const howItWorks = [
  {
    step: "01",
    title: "Define Care Demand",
    text: "Model staffing requirements by service, location, shift type and grade. Understand patient acuity and clinical activity to build rosters around care needs, not just headcounts.",
  },
  {
    step: "02",
    title: "Build & Optimise Rosters",
    text: "Our AI engine creates fair, efficient rosters that balance staff preferences, compliance rules, budget constraints and clinical safety. Multi-professional and cross-site scheduling handled automatically.",
  },
  {
    step: "03",
    title: "Deploy & Monitor",
    text: "Publish rosters to staff via the mobile app. Monitor real-time staffing against demand with live dashboards. Automatically escalate gaps through internal bank before agency.",
  },
  {
    step: "04",
    title: "Adapt & Improve",
    text: "Dynamic rostering responds to real-time changes. Predictive AI learns from patterns to improve future rosters, reduce costs and ensure safer staffing outcomes continuously.",
  },
];
    ...
    <div className="min-h-screen bg-background">
      ...
      <section className="relative flex min-h-[90vh] items-center overflow-hidden bg-foreground">
        <div
          ...
          style={{ backgroundImage: `url(${rosteringHero})` }}
        />
          ...
          <div className="grid items-center gap-16 lg:grid-cols-2">
            <motion.div initial="hidden" animate="visible" variants={fadeUp}>
              ...
              <h1 className="text-5xl font-bold leading-[1.05] tracking-tight text-primary-foreground md:text-6xl lg:text-7xl">
                Smarter rostering for
                <br />
                <span className="text-[#0075FF]">safer care</span>
              </h1>
              <p className="mt-8 max-w-lg text-lg leading-relaxed text-primary-foreground/60">
                The only end-to-end roster solution built for multi-professional
                health and care teams. Fully integrated rostering, absence
                management, temporary staffing and real-time command — giving you
                complete control of costs, quality and staff experience.
              </p>
          ...
          <div className="grid gap-16 lg:grid-cols-[1fr_1.5fr]">
            ...
            >
              ...
              <p className="mt-6 text-lg leading-relaxed text-muted-foreground">
                Scheduling health and care staff is increasingly complex. Flexzo
                Rostering cuts through this complexity to help control cost,
                improve staff experience and make care safer.
              </p>
            </motion.div>
      ...
      <section className="relative bg-foreground py-32 lg:py-40">
        ...
        <div className="relative z-10 mx-auto max-w-4xl px-6 text-center">
          ...
          >
            Get the right people, in the right place, at the{" "}
            <span className="text-[#0075FF]">right time</span>.
          </motion.p>
        </div>
      </section>
        ...
        <div className="mx-auto max-w-4xl px-6 text-center">
          ...
          >
            ...
            <p className="mx-auto mt-6 max-w-xl text-lg text-muted-foreground">
              Book a demo and discover how Flexzo Rostering can transform your
