...
const features = [
  {
    ...
    description:
      "Sequence messages across push, SMS, email, voice and in-app channels with A/B testing and campaign templates.",
  },
  {
    icon: Gift,
    title: "Incentive Orchestration & Governance",
    description:
      "Configurable monetary and non-monetary rewards tied to outcomes, with audit trails and fairness/rotation rules.",
  },
  {
    icon: BrainCircuit,
    title: "Behavioural Segmentation & Predictive Models",
    description:
      "Identify high-value cohorts, predict responsiveness and flag at-risk staff for retention interventions.",
  },
  {
    icon: Link2,
    title: "Closed-Loop Integrations",
    description:
      "Bi-directional APIs to Candidate Portal, Mobile App, Staff Bank, E-Rostering and payroll for campaign → roster → pay reconciliation.",
  },
  {
    icon: BarChart3,
    title: "ROI & Operational Analytics",
    description:
      "Campaign attribution, uplift measurement, incentive ROI calculators and dashboards that tie engagement to agency replacement and cost savings.",
  },
];
...
const benefits = [
  {
    icon: TrendingUp,
    title: "Self-Sustaining Talent Network",
    description:
      "Builds a growing database of candidates over time, reducing future sourcing effort.",
  },
  {
    icon: Users,
    title: "Reduced Agency Dependency",
    description:
      "Internal activation and direct sourcing replace premium external supply.",
  },
  {
    icon: Globe,
    title: "Expanded Candidate Reach",
    description:
      "Campaigns extend into new regions and specialties for hard-to-fill roles.",
  },
  {
    icon: Eye,
    title: "Continuous Visibility",
    description:
      "Hard-to-fill roles maintain active presence across trusted job engines and aggregators.",
  },
  {
    icon: Megaphone,
    title: "Transparent ROI",
    description:
      "Engagement spend converts into predictable operational capacity with measurable outcomes.",
  },
];
    ...
    <div className="min-h-screen bg-background">
      ...
      <section className="relative flex min-h-[90vh] items-center overflow-hidden bg-foreground">
        <div className="absolute inset-0 opacity-[0.03]" style={{
          backgroundImage: "radial-gradient(circle at 70% 30%, hsl(210 100% 45% / 0.4) 0%, transparent 60%)"
        }} />
          ...
          <div className="grid items-center gap-16 lg:grid-cols-2">
            <motion.div initial="hidden" animate="visible" variants={fadeUp}>
              ...
              <h1 className="text-5xl font-bold leading-[1.05] tracking-tight text-primary-foreground md:text-6xl lg:text-7xl">
                Activate talent,
                <br />
                <span className="text-[#0075FF]">amplify reach</span>
              </h1>
              <p className="mt-8 max-w-lg text-lg leading-relaxed text-primary-foreground/60">
                When a role has limited or no matching clinicians, Amplify cascades
                it into optimised vacancy campaigns across high-performing external
                sources — attracting fresh candidates directly into your database.
              </p>
      ...
      <section className="py-28 lg:py-36">
        <div className="mx-auto max-w-7xl px-6">
          <div className="grid gap-16 lg:grid-cols-[1fr_1.5fr]">
            ...
            >
              <p>
                Flexzo Amplify turns behavioural science into measurable coverage:
                omnichannel nudges, incentive orchestration and predictive analytics
                that increase internal activation, reduce agency dependence and
                deliver transparent ROI.
              </p>
              <p>
                The platform automatically identifies jobs with no matching candidates
                and sends them to the advertising engine for external promotion.
                Campaigns are optimised for reach and cost-per-application across
                trusted job engines, aggregators and media channels.
              </p>
              <p>
                New candidates flow directly back into your CRM, growing your database
                and improving future matching accuracy. Integrated, auditable and
                governed for healthcare.
              </p>
            </motion.div>
          </div>
        </div>
            ...
            {[
              {
                step: "01",
                title: "Identify Gaps",
                text: "The platform automatically identifies jobs with no matching candidates in your existing database, flagging roles that need external sourcing.",
                icon: Eye,
              },
              {
                step: "02",
                title: "Launch Campaigns",
                text: "Roles are sent to the advertising engine for external promotion. Campaigns are optimised for reach and cost-per-application across trusted job engines, aggregators and media channels.",
                icon: Megaphone,
              },
              {
                step: "03",
                title: "Attract & Capture",
                text: "New candidates flow directly back into your CRM, growing your database and improving future matching accuracy. Omnichannel nudges keep candidates engaged.",
                icon: Users,
              },
              {
                step: "04",
                title: "Measure & Optimise",
                text: "Campaign attribution, uplift measurement and incentive ROI calculators tie engagement spend to agency replacement and cost savings. Continuous optimisation improves results over time.",
                icon: BarChart3,
              },
            ].map((item, i) => (
              <motion.div
      ...
      <section className="relative bg-foreground py-32 lg:py-40">
        ...
        <div className="relative z-10 mx-auto max-w-4xl px-6 text-center">
          ...
          >
            Convert engagement spend into{" "}
            <span className="text-[#0075FF]">predictable operational capacity</span>.
          </motion.p>
        </div>
      </section>
        ...
        <div className="mx-auto max-w-4xl px-6 text-center">
          ...
          >
            <h2 className="text-4xl font-bold tracking-tight text-foreground md:text-5xl">
              Ready to <span className="text-[#0075FF]">amplify</span> your reach?
            </h2>
            <p className="mx-auto mt-6 max-w-xl text-lg text-muted-foreground">
              Book a demo and discover how Amplify can build your talent
              network and reduce agency dependency.
            </p>
